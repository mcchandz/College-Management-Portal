...
<body>
  ...
  <form action="" method="post" >
    ...
    <select class="dropdown" name="scheme" id="scheme">
       ...
       <label for="Sub1">18XX71: <input type="text" id="Marks" name="7m1" required><br></label>
       </div>
 
       <div class="admin-options">
       <label for="Sub1">18XX72: <input type="text" id="Marks" name="7m2" required><br></label>
       </div>

       <div class="admin-options">
       <label for="Sub1">18XX73X: <input type="text" id="Marks" name="7m3" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX74X: <input type="text" id="Marks" name="7m4" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX75X: <input type="text" id="Marks" name="7m5" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XXL76: <input type="text" id="Marks" name="7m6" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XXP77/L77: <input type="text" id="Marks" name="7m7" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XXP78: <input type="text" id="Marks" name="7m8"><br></label>
       </div>
...
if (request.getMethod().equals("POST")) {
    try {
        ...
        String m1 = request.getParameter("7m1");
        String m2 = request.getParameter("7m2");
        String m3 = request.getParameter("7m3");
        String m4 = request.getParameter("7m4");
        String m5 = request.getParameter("7m5");
        String m6 = request.getParameter("7m6");
        String m7 = request.getParameter("7m7");
        String m8 = request.getParameter("7m8");
       
        
        PreparedStatement ps = con.prepareStatement("select * from sem7 where usn = ?;");			
		ps.setString(1, susn);
		...
		if(rs.next()) {
	        ...
	        out.println("window.location.href='addres7.jsp';");
	        out.println("</script>");
		}
		else {
        
        ps = con.prepareStatement("insert into sem7 (usn, sem, branch, scheme, `18XX71`, `18XX72`, `18XX73X`, `18XX74X`, `18XX75X`, `18XXL76`, `18XXP77/L77`, `18XXP78`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ps.setString(1, susn);
        ps.setString(2, ssem);
