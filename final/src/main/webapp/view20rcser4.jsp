...
<title>GECH - Results CS(4) - 2020</title>
<style>
    td, th {
       text-align: center;
       padding: 10px 10px;
...
<% try{
    ...
    String sql="SELECT * FROM  sem4 WHERE branch = 'CSE' AND usn LIKE '4GH20CS%' OR usn LIKE '4gh20cs%';";
    ...
    while(rs.next()){
        ...
        String m1 = rs.getString("18MAT41");
        String m2 = rs.getString("18XX42");
        String m3 = rs.getString("18XX43");
        String m4 = rs.getString("18XX44");
        String m5 = rs.getString("18XX45");
        String m6 = rs.getString("18XX46");
        String m7 = rs.getString("18XXL47");
        String m8 = rs.getString("18XXL48");
        String m9 = rs.getString("18CPC49/KAN");
%>
    <tr>
    <td><%= susn %></td>
    <td><%= ssem %></td>
