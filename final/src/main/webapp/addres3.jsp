...
<header>
    ...
    <select class="dropdown" name="scheme" id="scheme">
        ...
        <div class="admin-options">
            <label for="Sub1">18MAT31: <input type="text" id="Marks" name="3m1" required><br></label>
        </div>

        <div class="admin-options">
            <label for="Sub1">18XX32: <input type="text" id="Marks" name="3m2" required><br></label>
        </div>
        
        <div class="admin-options">
            <label for="Sub1">18XX33: <input type="text" id="Marks" name="3m3" required><br></label>
        </div>
        
        <div class="admin-options">
            <label for="Sub1">18XX34: <input type="text" id="Marks" name="3m4" required><br></label>
        </div>
        
        <div class="admin-options">
            <label for="Sub1">18XX35: <input type="text" id="Marks" name="3m5" required><br></label>
        </div>
        
        <div class="admin-options">
            <label for="Sub1">18XX36: <input type="text" id="Marks" name="3m6" required><br></label>
        </div>
        
        <div class="admin-options">
            <label for="Sub1">18XXL37: <input type="text" id="Marks" name="3m7" required><br></label>
        </div>
        
        <div class="admin-options">
            <label for="Sub1">18XXL38: <input type="text" id="Marks" name="3m8" required><br></label>
        </div>
        
        <div class="admin-options">
            <label for="Sub1">18CPC39/KAN: <input type="text" id="Marks" name="3m9" required><br></label>
        </div>
...
if (request.getMethod().equals("POST")) {
    try {
        ...
        String m1 = request.getParameter("3m1");
        String m2 = request.getParameter("3m2");
        String m3 = request.getParameter("3m3");
        String m4 = request.getParameter("3m4");
        String m5 = request.getParameter("3m5");
        String m6 = request.getParameter("3m6");
        String m7 = request.getParameter("3m7");
        String m8 = request.getParameter("3m8");
        String m9 = request.getParameter("3m9");
        
        PreparedStatement ps = con.prepareStatement("select * from sem3 where usn = ?;");			
		ps.setString(1, susn);
		...
		if(rs.next()) {
	        ...
	        out.println("window.location.href='addres3.jsp';");
	        out.println("</script>");
		}
		else {
        
        ps = con.prepareStatement("insert into sem3 (usn, sem, branch, scheme, `18MAT31`, `18XX32`, `18XX33`, `18XX34`, `18XX35`, `18XX36`, `18XXL37`, `18XXL38`, `18CPC39/KAN`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ps.setString(1, susn);
        ps.setString(2, ssem);
