...
<body>
  ...
  <form action="" method="post" >
    ...
    <select class="dropdown" name="scheme" id="scheme">
       ...
       <label for="Sub1">18MAT21: <input type="text" id="Marks" name="21m1" required><br></label>
       </div>
 
       <div class="admin-options">
       <label for="Sub1">18CHE22: <input type="text" id="Marks" name="21m2" required><br></label>
       </div>

       <div class="admin-options">
       <label for="Sub1">18CPS23: <input type="text" id="Marks" name="21m3" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18ELN24: <input type="text" id="Marks" name="21m4" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18ME25: <input type="text" id="Marks" name="21m5" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18CHEL26: <input type="text" id="Marks" name="21m6" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18CPL27: <input type="text" id="Marks" name="21m7" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18EGH28: <input type="text" id="Marks" name="21m8" required><br></label>
       </div>
...
if (request.getMethod().equals("POST")) {
    try {
        ...
        String m1 = request.getParameter("21m1");
        String m2 = request.getParameter("21m2");
        String m3 = request.getParameter("21m3");
        String m4 = request.getParameter("21m4");
        String m5 = request.getParameter("21m5");
        String m6 = request.getParameter("21m6");
        String m7 = request.getParameter("21m7");
        String m8 = request.getParameter("21m8");
        
        PreparedStatement ps = con.prepareStatement("select * from chem_cycle2 where usn = ?;");			
		ps.setString(1, susn);
		...
		if(rs.next()) {
	        ...
	        out.println("window.location.href='addres2che.jsp';");
	        out.println("</script>");
		}
		else {
        
        ps = con.prepareStatement("insert into chem_cycle2 (usn, sem, cycle, branch, scheme, `18MAT21`, `18CHE22`, `18CPS23`, `18ELN24`, `18ME25`, `18CHEL26`, `18CPL27`, `18EGH28`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ps.setString(1, susn);
        ps.setString(2, ssem);
