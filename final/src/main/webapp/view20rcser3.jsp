...
<title>GECH - Results CS(3) - 2020</title>
<style>
    td, th {
       text-align: center;
       padding: 10px 10px;
...
<body>
    ...
    <br>
       ...
       <tr><th>USN</th><th>Semester</th><th>Branch</th><th>18MAT31</th><th>18XX32</th><th>18XX33</th><th>18XX34</th><th>18XX35</th><th>18XX36</th><th>18XXL37</th><th>18XXL38</th><th>18CPC39/KAN</th></tr>
<% try{
    Class.forName("com.mysql.cj.jdbc.Driver");
    Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/cmp", "root", "password");              
    Statement stmt=con.createStatement();
    
    String sql="SELECT * FROM  sem3 WHERE branch = 'CSE' AND usn LIKE '4GH20CS%' OR usn LIKE '4gh20cs%';";
