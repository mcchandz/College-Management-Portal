...
<body>
  ...
  <form action="" method="post" >
    ...
    <select class="dropdown" name="scheme" id="scheme">
       ...
       <label for="Sub1">18XX51: <input type="text" id="Marks" name="5m1" required><br></label>
       </div>
 
       <div class="admin-options">
       <label for="Sub1">18XX52: <input type="text" id="Marks" name="5m2" required><br></label>
       </div>

       <div class="admin-options">
       <label for="Sub1">18XX53: <input type="text" id="Marks" name="5m3" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX54: <input type="text" id="Marks" name="5m4" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX55: <input type="text" id="Marks" name="5m5" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX56: <input type="text" id="Marks" name="5m6" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XXL57: <input type="text" id="Marks" name="5m7" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XXL58: <input type="text" id="Marks" name="5m8" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">EVS:<input type="text" id="Marks" name="5m9" required><br></label>
       </div>
...
if (request.getMethod().equals("POST")) {
    try {
        ...
        String m1 = request.getParameter("5m1");
        String m2 = request.getParameter("5m2");
        String m3 = request.getParameter("5m3");
        String m4 = request.getParameter("5m4");
        String m5 = request.getParameter("5m5");
        String m6 = request.getParameter("5m6");
        String m7 = request.getParameter("5m7");
        String m8 = request.getParameter("5m8");
        String m9 = request.getParameter("5m9");
        
        PreparedStatement ps = con.prepareStatement("select * from sem5 where usn = ?;");			
		ps.setString(1, susn);
		...
		if(rs.next()) {
	        ...
	        out.println("window.location.href='addres5.jsp';");
	        out.println("</script>");
		}
		else {
        
        ps = con.prepareStatement("insert into sem5 (usn, sem, branch, scheme, `18XX51`, `18XX52`, `18XX53`, `18XX54`, `18XX55`, `18XX56`, `18XXL57`, `18XXL58`, `EVS`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ps.setString(1, susn);
        ps.setString(2, ssem);
