...
<body>
  ...
  <form action="" method="post" >
    ...
    <select class="dropdown" name="scheme" id="scheme">
       ...
       <label for="Sub1">18MAT41: <input type="text" id="Marks" name="4m1" required><br></label>
       </div>
 
       <div class="admin-options">
       <label for="Sub1">18XX42: <input type="text" id="Marks" name="4m2" required><br></label>
       </div>

       <div class="admin-options">
       <label for="Sub1">18XX43: <input type="text" id="Marks" name="4m3" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX44: <input type="text" id="Marks" name="4m4" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX45: <input type="text" id="Marks" name="4m5" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XX46: <input type="text" id="Marks" name="4m6" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XXL47: <input type="text" id="Marks" name="4m7" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18XXL48: <input type="text" id="Marks" name="4m8" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18CPC49/KAN:<input type="text" id="Marks" name="4m9" required><br></label>
       </div>
...
if (request.getMethod().equals("POST")) {
    try {
        ...
        String m1 = request.getParameter("4m1");
        String m2 = request.getParameter("4m2");
        String m3 = request.getParameter("4m3");
        String m4 = request.getParameter("4m4");
        String m5 = request.getParameter("4m5");
        String m6 = request.getParameter("4m6");
        String m7 = request.getParameter("4m7");
        String m8 = request.getParameter("4m8");
        String m9 = request.getParameter("4m9");
        
        PreparedStatement ps = con.prepareStatement("select * from sem4 where usn = ?;");			
		ps.setString(1, susn);
		...
		if(rs.next()) {
	        ...
	        out.println("window.location.href='addres4.jsp';");
	        out.println("</script>");
		}
		else {
        
        ps = con.prepareStatement("insert into sem4 (usn, sem, branch, scheme, `18MAT41`, `18XX42`, `18XX43`, `18XX44`, `18XX45`, `18XX46`, `18XXL47`, `18XXL48`, `18CPC49/KAN`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ps.setString(1, susn);
        ps.setString(2, ssem);
