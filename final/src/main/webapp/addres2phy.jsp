...
<body>
  ...
  <form action="" method="post" >
    ...
    <select class="dropdown" name="scheme" id="scheme">
       ...
       <label for="Sub1">18MAT21: <input type="text" id="Marks" name="22m1" required><br></label>
       </div>
 
       <div class="admin-options">
       <label for="Sub1">18PHY22: <input type="text" id="Marks" name="22m2" required><br></label>
       </div>

       <div class="admin-options">
       <label for="Sub1">18ELE23: <input type="text" id="Marks" name="22m3" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18CIV24: <input type="text" id="Marks" name="22m4" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18EGDL25: <input type="text" id="Marks" name="22m5" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18PHYL26: <input type="text" id="Marks" name="22m6" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18ELEL27: <input type="text" id="Marks" name="22m7" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18EGH28: <input type="text" id="Marks" name="22m8" required><br></label>
       </div>
...
if (request.getMethod().equals("POST")) {
    try {
        ...
        String m1 = request.getParameter("22m1");
        String m2 = request.getParameter("22m2");
        String m3 = request.getParameter("22m3");
        String m4 = request.getParameter("22m4");
        String m5 = request.getParameter("22m5");
        String m6 = request.getParameter("22m6");
        String m7 = request.getParameter("22m7");
        String m8 = request.getParameter("22m8");
        
        PreparedStatement ps = con.prepareStatement("select * from phy_cycle2 where usn = ?;");			
		ps.setString(1, susn);
		...
		if(rs.next()) {
	        ...
	        out.println("window.location.href='addres2phy.jsp';");
	        out.println("</script>");
		}
		else {
        
        ps = con.prepareStatement("insert into phy_cycle2 (usn, sem, cycle, branch, scheme, `18MAT21`, `18PHY22`, `18ELE23`, `18CIV24`, `18EGDL25`, `18PHYL26`, `18ELEL27`, `18EGH28`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ps.setString(1, susn);
        ps.setString(2, ssem);
