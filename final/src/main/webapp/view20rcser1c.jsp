...
<title>GECH - Results CS(1) - 2020</title>
<style>
    td, th {
       text-align: center;
       padding: 10px 10px;
...
<body>
       <header>
    <h1>
    Results of CSE-2020(Sem 1-C cycle)
    </h1>
     </header>
...
<% try{
    ...
    String sql="SELECT * FROM  chem_cycle1 WHERE branch = 'CSE' AND usn LIKE '4GH20CS%' OR usn LIKE '4gh20cs%';";
