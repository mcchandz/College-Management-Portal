...
<body>
  ...
  <form action="" method="post" >
    ...
    <select class="dropdown" name="scheme" id="scheme">
       ...
       <label for="Sub1">18MAT11: <input type="text" id="Marks" name="11m1" required><br></label>
       </div>
 
       <div class="admin-options">
       <label for="Sub1">18CHE12: <input type="text" id="Marks" name="11m2" required><br></label>
       </div>

       <div class="admin-options">
       <label for="Sub1">18CPS13: <input type="text" id="Marks" name="11m3" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18ELN14: <input type="text" id="Marks" name="11m4" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18ME15: <input type="text" id="Marks" name="11m5" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18CHEL16: <input type="text" id="Marks" name="11m6" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18CPL17: <input type="text" id="Marks" name="11m7" required><br></label>
       </div>
       
       <div class="admin-options">
       <label for="Sub1">18EGH18: <input type="text" id="Marks" name="11m8" required><br></label>
       </div>
...
if (request.getMethod().equals("POST")) {
    try {
        ...
        String m1 = request.getParameter("11m1");
        String m2 = request.getParameter("11m2");
        String m3 = request.getParameter("11m3");
        String m4 = request.getParameter("11m4");
        String m5 = request.getParameter("11m5");
        String m6 = request.getParameter("11m6");
        String m7 = request.getParameter("11m7");
        String m8 = request.getParameter("11m8");
        
        PreparedStatement ps = con.prepareStatement("select * from chem_cycle1 where usn = ?;");			
		ps.setString(1, susn);
		...
		if(rs.next()) {
	        ...
	        out.println("window.location.href='addres1che.jsp';");
	        out.println("</script>");
		}
		else {
        
        ps = con.prepareStatement("insert into chem_cycle1 (usn, sem, cycle, branch, scheme, `18MAT11`, `18CHE12`, `18CPS13`, `18ELN14`, `18ME15`, `18CHEL16`, `18CPL17`, `18EGH18`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        ps.setString(1, susn);
        ps.setString(2, ssem);
