...
<title>GECH - Results CS(8) - 2020</title>
<style>
    td, th {
       text-align: center;
       padding: 10px 10px;
...
<body>
    ...
    <br>
       ...
       <tr><th>USN</th><th>Semester</th><th>Branch</th><th>18XX81</th><th>18XX82X</th><th>18XXP83</th><th>18XXS84</th><th>18XX185</th></tr>
<% try{
    Class.forName("com.mysql.cj.jdbc.Driver");
    Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/cmp", "root", "password");              
    Statement stmt=con.createStatement();
    
    String sql="SELECT * FROM  sem8 WHERE branch = 'CSE' AND usn LIKE '4GH20CS%' OR usn LIKE '4gh20cs%';";
    ...
    while(rs.next()){
        ...
        String m1 = rs.getString("18XX81");
        String m2 = rs.getString("18XX82X");
        String m3 = rs.getString("18XXP83");
        String m4 = rs.getString("18XXS84");
        String m5 = rs.getString("18XX185");
%>
    <tr>
    <td><%= susn %></td>
    <td><%= ssem %></td>
